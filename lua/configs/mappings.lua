...
return {
  { "<C-Right>",     actions.move_next_word,          except = mode.terminal },
  { "<C-Left>",      actions.move_previous_word,      except = mode.terminal },
  ...
  { "<C-t>",         actions.run_associated_tests,    except = mode.terminal },
  { "<C-T>",         actions.toggle_test_explorer,    except = mode.terminal },
  -- { "<C-R>", actions.run_all_tests, except = mode.terminal },
  ...
  { "e",             actions.rename_file,             where = actions.explorer },
